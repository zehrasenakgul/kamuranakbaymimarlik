...
@section('content')
    ...
    <div class="layout-px-spacing">
        <div class=" layout-top-spacing">
            ...
            <form class="form-vertical" enctype="multipart/form-data" action="{{ url('admin/documents/' . $document->id) }}"
                method="POST">
                ...
                <div class="form-group mb-4">
                    ...
                    <select class="form-control" name="status" id="exampleFormControlSelect1">
                        <option value="1" @if ($document->status == '1') selected @endif>Aktif</option>
                        <option value="0" @if ($document->status == '0') selected @endif>Pasif</option>
                    </select>
                </div>
                <div class="form-group custom-file-container mb-4" data-upload-id="myFirstImage">
                    ...
                    <div class="card component-card_2 mb-3" style="width:150px">
                        <img src="{{ asset('storage/' . $document->image) }}" class="card-img-top" alt="widget-card-2">
                    </div>
